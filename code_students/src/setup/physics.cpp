...
void physics::get_lambda_min_max(double &lambda_min, double &lambda_max, const fluid_cell &fluid_left_cell, const fluid_cell &fluid_right_cell,
	...
	double density_left = fluid_left_cell.fluid_data[fluid_left_cell.get_index_density()];  
	double density_right = fluid_right_cell.fluid_data[fluid_right_cell.get_index_density()]; 
